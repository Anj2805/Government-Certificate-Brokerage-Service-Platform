...
export default function Login() {
  ...
  const onSubmit = async (values) => {
    ...
    try {
      ...
      } else if (msg.includes('registered as a Citizen')) {
        toast.error('Redirecting to Citizen portal...');
        ...
        <div className="relative w-full max-w-[480px]">
          ...
          <section className="relative w-full bg-white rounded-[24px] shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-[#e2e8f0] p-8" aria-labelledby="login-title">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h1 id="login-title" className="mt-4 text-[26px] font-extrabold text-[#0f294a] tracking-tight">Agent Portal</h1>
