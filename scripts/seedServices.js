...
const services = [
  {
    ...
    requiredDocuments: ['Identity Proof', 'Address Proof', 'Income Proof', 'Passport Size Photo'],
  ...
  },
  {
    ...
    requiredDocuments: ['Hospital Birth Record', 'Parent Identity Proof', 'Address Proof'],
  ...
  },
  {
    ...
    requiredDocuments: ['Identity Proof', 'Address Proof', 'Caste Proof', 'Family Certificate'],
  ...
  },
  {
    ...
    requiredDocuments: ['Identity Proof', 'Address Proof', 'Residence Proof', 'Passport Size Photo'],
  ...
  },
  {
    ...
    requiredDocuments: ['Identity Proof', 'Address Proof', 'Date of Birth Proof', 'Passport Size Photo'],
